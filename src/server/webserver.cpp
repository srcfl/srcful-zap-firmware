...
void WebServerHandler::setupEndpoints() {
    ...
    server.on("/api/wifi", HTTP_POST, [this]() {
        ...
        request.method = EndpointVerb::POST;
    ...
    server.on("/api/system/info", HTTP_GET, [this]() {
        EndpointRequest request;
        request.method = EndpointVerb::GET;
    ...
    server.on("/api/wifi", HTTP_DELETE, [this]() {
        EndpointRequest request;
        request.method = EndpointVerb::DELETE;
    ...
    server.onNotFound([this]() {
        ...
        EndpointRequest request;
        request.method = server.method() == HTTP_GET ? EndpointVerb::GET : EndpointVerb::POST;
